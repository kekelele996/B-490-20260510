      ...
      <el-card class="register-card" shadow="hover">
        ...
        <el-form :model="form" label-position="top" size="large">
          ...
          <el-form-item label="邀请码（选填）">
            <el-input v-model="form.inviteCode" placeholder="如有邀请码请输入" :prefix-icon="Tickets" />
          </el-form-item>
          <el-form-item>
...
import { User, Lock, Avatar, Iphone, Check, Message, Tickets } from '@element-plus/icons-vue'
